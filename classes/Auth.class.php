...
class User
{
    ...
    private $db_name = "tch12";
    private $db_user = "tch12";
    private $db_pass = "spadec";
    ...
    public function saveSession($remember = false, $http_only = true, $days = 7)
    {
        ...
        $sdb = new SafeMySQL($config); 
        $test = new UserController($sdb);
        
        $_SESSION["user_id"] = $this->user_id;
        $result = $test->SetUserData($this->user_id);
